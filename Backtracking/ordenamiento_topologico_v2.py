""" Implementar un algoritmo que, por backtracking, obtenga la cantidad todos los posibles ordenamientos topológicos de 
...
def contar_ordenamientos(grafo):
    ...
    _contar_ordenamientos_rec(k, grafo, [], ordenamientos, grados_entrada)
    return ordenamientos

def _contar_ordenamientos_rec(k, grafo, solucion, soluciones, grados_entrada):
    ...
    for v in vertices_posibles_a_agregar:
        ...
        _contar_ordenamientos_rec(k, grafo, solucion, soluciones, grados_entrada)
